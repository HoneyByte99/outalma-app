...
class _SignInPageState extends ConsumerState<SignInPage>
    with OtpResendCooldown<SignInPage> {
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      if (!result.signedIn) {
        ...
        // Preserve the return-to-intention target across the hop, so a
        // visitor who came here to book still lands on that booking.
  ...
  void _editPhone() {
    // Back on the number step there is no resend button to gate, and a running
