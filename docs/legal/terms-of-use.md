...
Outalma met en relation des **clients** recherchant un service et des **prestataires** proposant ce service. Outalma fournit la plateforme technique de mise en relation : recherche, réservation, échange et évaluation.
...
- L'inscription nécessite une adresse email valide ou un numéro de téléphone, et la fourniture d'informations exactes.
- L'Application est réservée aux personnes âgées d'au moins **16 ans**.
...
Le cycle de vie d'une réservation suit des étapes précises :

1. **Demande** : le client envoie une demande de réservation à un prestataire.
2. **Acceptation / Refus** : le prestataire accepte ou refuse la demande.
3. **Coordination** : après acceptation, le chat est débloqué et les coordonnées (numéro de téléphone) deviennent visibles entre les deux participants pour organiser la prestation.
4. **Réalisation** : le prestataire indique le démarrage de la prestation.
5. **Confirmation** : le client confirme la fin de la prestation.
6. **Évaluation** : après la fin, le client et le prestataire peuvent chacun laisser un avis.
...
- Les tarifs des services sont fixés librement par chaque prestataire et affichés sur sa fiche.
...
- publier des informations fausses, trompeuses ou illégales ;
- proposer ou réserver des services illicites, dangereux ou contraires aux bonnes mœurs ;
- harceler, menacer, diffamer ou discriminer un autre utilisateur ;
- contourner la plateforme dans le but de frauder ou de nuire à autrui ;
- usurper l'identité d'un tiers ou collecter les données d'autres utilisateurs sans consentement ;
- perturber le fonctionnement technique de l'Application.
...
Vous restez responsable du contenu que vous publiez (fiches de services, messages, photos, messages vocaux, avis). En le publiant, vous garantissez en détenir les droits et accordez à Outalma une licence limitée pour l'héberger et l'afficher dans le cadre du service.
...
- Les avis sont bilatéraux : après une prestation terminée, le client peut évaluer le prestataire et le prestataire peut évaluer le client.
